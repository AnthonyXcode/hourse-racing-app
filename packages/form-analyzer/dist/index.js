...
__export(index_exports, {
  DEFAULT_BETTING_CONFIG: () => DEFAULT_BETTING_CONFIG,
  DEFAULT_SCRAPER_CONFIG: () => DEFAULT_SCRAPER_CONFIG,
  FormAnalyzer: () => FormAnalyzer,
  MONTE_CARLO_RUNS: () => MONTE_CARLO_RUNS,
  MonteCarloSimulator: () => MonteCarloSimulator,
  SpeedRatingCalculator: () => SpeedRatingCalculator,
  analyzeHorse: () => analyzeHorse,
  analyzeRace: () => analyzeRace,
  calculateEdge: () => calculateEdge,
  calculateFormScore: () => calculateFormScore,
  calculateSpeedFigure: () => calculateSpeedFigure,
  clamp: () => clamp,
  createSimulator: () => createSimulator,
  createSimulatorForRace: () => createSimulatorForRace,
  defaultSimulator: () => defaultSimulator,
  formAnalyzer: () => formAnalyzer,
  formatCurrency: () => formatCurrency,
  formatPercent: () => formatPercent,
  oddsToProb: () => oddsToProb,
  parseFormString: () => parseFormString,
  performanceStdDevForVenue: () => performanceStdDevForVenue,
  probToOdds: () => probToOdds,
  projectSpeedRating: () => projectSpeedRating,
...
var FormAnalyzer = class {
  ...
  calculateDaysSinceLastRace(horse, raceDate) {
    ...
    return (0, import_date_fns.differenceInDays)(raceDate, lastRace.date);
  }
  /**
